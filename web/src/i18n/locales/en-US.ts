export default {
    ...
    entities: {
        ...
        singleAssets: "Individual assets",
        search: "Search people, products, scenes, aliases, tags, or descriptions",
        add: "New entity",
        edit: "Edit entity",
        ...
        uploaded: "Uploaded {{count}} reference images",
        uploadFailed: "Reference image upload failed",
        uploadReferences: "Upload references",
        noSummary: "No entity summary yet",
        memberCount: "{{count}} reference assets",
        memberNote: "Purpose or angle of this asset",
        deleteTitle: "Delete entity",
        deleteConfirm: "Delete “{{name}}”? Its individual assets will be kept.",
        kinds: { person: "Person", product: "Product", scene: "Scene", style: "Style", brand: "Brand", other: "Other" },
        roles: { primary: "Primary", identity: "Identity", fullBody: "Full body", detail: "Detail", expression: "Expression", outfit: "Outfit", background: "Background", product: "Product", style: "Style", reference: "Reference" },
        fields: {
            name: "Entity name",
            nameRequired: "Enter an entity name",
            kind: "Entity type",
            aliases: "Aliases / trigger words",
            tags: "Tags",
            summary: "Short summary",
            description: "Detailed profile",
            prompt: "Canonical generation description",
            negativePrompt: "Avoid / negative prompt",
            usageRules: "Usage rules",
            members: "Linked assets",
            membersHint: "Label each asset so the Agent can choose references correctly",
            membersPlaceholder: "Select from individual assets",
        },
    },
    notFound: {
    ...
    canvas: {
        ...
        toolbar: {
            arrange: "Auto arrange (arranges selection when multiple nodes are selected)",
        ...
        sidePanel: {
            ...
            addingAssets: "Adding assets…", addedAssets: "Added {{count}} assets", mediaOnly: "Only image and video files are supported", addFailed: "Failed to add assets. Try again.", searchAssets: "Search assets or entities", add: "Add", noAssets: "No assets", inserted: "Insert into canvas", removeAssetTitle: "Remove this asset?", remove: "Remove", removeAsset: "Remove asset", assetRemoved: "Asset removed", entities: "Entity assets", entityReferences: "{{count}} references", insertEntity: "Place the complete entity board on canvas", entityInserted: "Placed entity “{{name}}” on canvas",
        ...
        nodeToolbar: { disable: "Disable", disableTitle: "Temporarily exclude this node from generation inputs", enable: "Enable", enableTitle: "Include this node in generation inputs again", disabled: "Disabled", disabledGeneration: "This node is disabled and cannot run generation", noPrompt: "No prompt to copy", infoTitle: "View node information", info: "Info", removeTitle: "Remove node", retryTitle: "Generate again", queryVideoTask: "Get task status", queryVideoTaskTitle: "Query video generation status by task ID", videoTaskId: "Task ID", saveAsset: "Save asset", addToAgent: "Send to Agent", addToAgentTitle: "Add this node to the Agent composer", addedToAgent: "Added “{{name}}” to Agent", addToAgentUnavailable: "This node has no content that Agent can use", downloadAudio: "Download audio", downloadVideo: "Download video", downloadImage: "Download image", editTextTitle: "Edit text", editText: "Edit text", decreaseFont: "Decrease font size", increaseFont: "Increase font size", zoomOut: "Smaller", zoomIn: "Larger", uploadImage: "Upload image", replaceVideo: "Replace video", uploadVideo: "Upload video", replaceAudio: "Replace audio", uploadAudio: "Upload audio", nodeInfo: "Node information", name: "Name", type: "Type", size: "Size", position: "Position", status: "Status", imageGroup: "Image group", imageSize: "Image size", group: "Group", groupTitle: "Wrap selected nodes in a group", ungroup: "Ungroup", ungroupTitle: "Remove grouping from selected nodes" },
    ...
    agent: {
        uploadFile: "Upload image, video, or file",
        removeFile: "Remove attachment",
        attachmentPrompt: "Please process the uploaded attachments.",
        ...
        siteTools: { canvasList: "Canvas list", generationStatus: "Generation task status", imageConfig: "Image configuration", imageGenerate: "Generate in Image Studio", videoConfig: "Video configuration", videoGenerate: "Generate in Video Studio", promptSearch: "Search prompts", assetList: "Asset list", assetAdd: "Add asset", entitySearch: "Search entity assets", entityGet: "Read entity profile", entityAdd: "Create entity asset", entityPlace: "Place entity on canvas", unknownTool: "Unknown tool: {{name}}", canvasLoading: "The canvas is still loading. Try again shortly.", canvasHint: "Use site_navigate to open /canvas/{id}", assetsLoading: "Assets are still loading. Try again shortly.", assetTitleRequired: "Provide the asset title", textContentRequired: "content is required when kind=text", imageUrlRequired: "imageUrl is required when kind=image", imageReadFailed: "Could not read the image. Use a data URL or a cross-origin accessible image URL.", assetKindUnsupported: "assets_add supports only kind=text or kind=image", entityNotFound: "Entity not found. Search with entities_search first.", entityNameRequired: "Provide the entity name", entityPlaceHint: "The entity board is in the current viewport. Pass referenceNodeIds to image or video generation tools as references.", openCanvasFirst: "Open a canvas before placing an entity.", attachmentImportUnavailable: "This page cannot read chat attachments. Refresh and try again.", attachmentImportFailed: "Could not import chat attachment {{attachmentId}}", primaryReference: "Primary reference", referenceImage: "Reference", entityAttachmentSource: "Agent chat attachment", imageGenerationStarted: "Opened Image Studio and started generation. Use generation_get_status to query the task.", imageConfigApplied: "Opened Image Studio and applied the parameters without starting generation.", videoGenerationStarted: "Opened Video Studio and started generation. Use generation_get_status to query the task.", videoConfigApplied: "Opened Video Studio and applied the parameters without starting generation." },
        ...
        eventExtra: { toolNamed: "Call tool: {{name}}", toolOperation: "Tool operation", targetPage: "Target page", searchContent: "Search query", textContent: "Text content", operationContent: "Operations", imageCount: "Attachment count", tools: { generateImage: "Generate image", viewImage: "View image", executeCommand: "Run command", editFiles: "Edit files", searchWeb: "Search the web", canvasOps: "Canvas operations", readCanvas: "Read canvas", readSelection: "Read selection", exportSnapshot: "Export snapshot", createNode: "Create node", addAttachments: "Add attachment media", createText: "Create text", createTexts: "Create text nodes", createConfig: "Create generation config", createImageFlow: "Create image flow", createGenerationFlow: "Create generation flow", generateText: "Generate text", generateVideo: "Generate video", generateAudio: "Generate audio", updateNode: "Update node", updateText: "Update text", moveNodes: "Move nodes", resizeNode: "Resize node", deleteNodes: "Delete nodes", connectNodes: "Connect nodes", selectNodes: "Select nodes", setViewport: "Adjust viewport", runGeneration: "Run generation", openPage: "Open page" } },
        ...
        runtime: {
            attachmentTooLarge: "Attachments too large", attachmentPayloadTooLarge: "Attachments exceed about 28 MB. Remove some before sending.", filesSent: "Sent {{count}} attachments", tooManyFiles: "Too many attachments", fileCountLimit: "Uploaded files and referenced canvas images are limited to {{count}} in total.", attachmentLimit: "Attachments are limited to about 28 MB in total.", fileReadFailed: "Failed to read attachment",

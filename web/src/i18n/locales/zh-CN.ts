export default {
    ...
    entities: {
        ...
        updated: "实体已更新",
        source: "实体资产库",
        uploaded: "已上传 {{count}} 张参考图",
        uploadFailed: "参考图上传失败",
        uploadReferences: "上传参考图",
        noSummary: "尚未填写实体简介",
        memberCount: "{{count}} 项参考资产",
        memberNote: "这项素材的用途或角度",
        deleteTitle: "删除实体",
        deleteConfirm: "确定删除「{{name}}」吗？关联的单项资产将被保留。",
        kinds: { person: "人物", product: "产品", scene: "场景", style: "风格", brand: "品牌", other: "其他" },
        roles: { primary: "主参考", identity: "身份特征", fullBody: "全身", detail: "细节", expression: "表情", outfit: "服装", background: "背景", product: "产品", style: "风格", reference: "普通参考" },
        fields: {
            name: "实体名称",
            ...
            description: "详细档案",
            prompt: "固定生成描述",
            negativePrompt: "避免内容 / 负面提示词",
            usageRules: "使用规则",
            members: "关联资产",
            membersHint: "为每张素材标注角色，Agent 会据此选择参考图",
            membersPlaceholder: "从已有单项资产中选择",
        },
    },
    notFound: {
        title: "页面不存在",
    ...
    canvas: {
        ...
        sidePanel: {
            ...
            addingAssets: "正在添加资产…", addedAssets: "已添加 {{count}} 个资产", mediaOnly: "仅支持图片或视频文件", addFailed: "添加失败，请重试", searchAssets: "搜索资产或实体", add: "添加", noAssets: "暂无资产", inserted: "插入画布", removeAssetTitle: "移除该资产？", remove: "移除", removeAsset: "移除资产", assetRemoved: "资产已移除", entities: "实体资产", entityReferences: "{{count}} 个参考", insertEntity: "将完整实体板放入画布", entityInserted: "已将实体“{{name}}”放入画布",
    ...
    agent: {
        uploadFile: "上传图片、视频或文件",
        removeFile: "移除附件",
        attachmentPrompt: "请处理上传的附件。",
        ...
        siteTools: { canvasList: "画布列表", generationStatus: "生成任务状态", imageConfig: "生图配置", imageGenerate: "生图工作台生成", videoConfig: "视频配置", videoGenerate: "视频创作台生成", promptSearch: "搜索提示词", assetList: "资产列表", assetAdd: "添加资产", entitySearch: "搜索实体资产", entityGet: "读取实体档案", entityAdd: "创建实体资产", entityPlace: "将实体放入画布", unknownTool: "未知工具：{{name}}", canvasLoading: "画布还在加载中，请稍后重试", canvasHint: "用 site_navigate 跳转 /canvas/{id} 打开对应画布", assetsLoading: "资产还在加载中，请稍后重试", assetTitleRequired: "请提供资产标题 title", textContentRequired: "kind=text 时需要提供 content 文本内容", imageUrlRequired: "kind=image 时需要提供 imageUrl（图片地址或 dataURL）", imageReadFailed: "无法读取该图片地址，请改用 dataURL 或可跨域访问的图片链接", assetKindUnsupported: "assets_add 仅支持 kind=text 或 kind=image", entityNotFound: "未找到该实体，请先用 entities_search 搜索", entityNameRequired: "请提供实体名称 name", entityPlaceHint: "实体板已放入当前视口；referenceNodeIds 可继续作为图片或视频生成的参考节点", openCanvasFirst: "当前不在画布页，请先打开一个画布", attachmentImportUnavailable: "当前页面无法读取聊天附件，请刷新页面后重试", attachmentImportFailed: "无法导入聊天附件 {{attachmentId}}", primaryReference: "主参考", referenceImage: "参考图", entityAttachmentSource: "Agent 聊天附件", imageGenerationStarted: "已跳转生图工作台并触发生成，可用 generation_get_status 查询任务", imageConfigApplied: "已跳转生图工作台并填入参数，未触发生成", videoGenerationStarted: "已跳转视频创作台并触发生成，可用 generation_get_status 查询任务", videoConfigApplied: "已跳转视频创作台并填入参数，未触发生成" },
        ...
        eventExtra: { toolNamed: "调用工具：{{name}}", toolOperation: "工具操作", targetPage: "目标页面", searchContent: "搜索内容", textContent: "文本内容", operationContent: "操作内容", imageCount: "附件数量", tools: { generateImage: "生成图片", viewImage: "查看图片", executeCommand: "执行命令", editFiles: "修改文件", searchWeb: "搜索资料", canvasOps: "画布操作", readCanvas: "读取画布", readSelection: "读取选区", exportSnapshot: "导出快照", createNode: "创建节点", addAttachments: "添加附件媒体", createText: "创建文本", createTexts: "批量创建文本", createConfig: "创建生成配置", createImageFlow: "创建生图流程", createGenerationFlow: "创建生成流程", generateText: "生成文本", generateVideo: "生成视频", generateAudio: "生成音频", updateNode: "更新节点", updateText: "更新文本", moveNodes: "移动节点", resizeNode: "调整节点尺寸", deleteNodes: "删除节点", connectNodes: "连接节点", selectNodes: "选择节点", setViewport: "调整视口", runGeneration: "触发生成", openPage: "打开页面" } },
        ...
        runtime: {
            attachmentTooLarge: "附件过大", attachmentPayloadTooLarge: "附件总大小超过约 28MB，请删减后再发送。", filesSent: "发送了 {{count}} 个附件", tooManyFiles: "附件数量过多", fileCountLimit: "上传文件和引用的画布图片合计最多 {{count}} 个。", attachmentLimit: "附件总大小最多约 28MB。", fileReadFailed: "附件读取失败",
            ...
            submittingApproval: "正在提交权限决定", waitingCodexApproval: "等待 Codex 确认权限", approvalFailed: "权限审批失败", enableFullAccess: "启用完全访问权限", fullAccessDescription: "Codex 将不受沙箱限制，可访问互联网及本机任意文件。请仅在信任当前任务时使用。", enableFullAccessAction: "启用完全访问", offline: "离线", addressRequired: "请填写本地 Agent 地址", agentNotFound: "没有发现本地 Agent，请先在 Codex 使用插件或手动启动 Canvas Agent", invalidAddress: "本地 Agent 地址格式不正确", connecting: "连接中", creatingConversation: "正在新建对话", newConversation: "新对话", newConversationFailed: "新建对话失败", conversationResumed: "已恢复会话", resumeConversationFailed: "恢复对话失败", recordsDeleted: "已删除 {{count}} 条记录", deleteConversationFailed: "删除对话失败", deleteConversations: "删除 {{count}} 条对话记录", deleteConversationsDescription: "删除后无法恢复，确定继续吗？", importGeneratedImages: "导入生成图片", addedToSourceCanvas: "已添加到发起任务的画布", imageGenerated: "图片已生成", noImageAttachments: "没有可添加的媒体附件", invalidAttachmentNode: "媒体附件节点参数无效", attachmentReadFailed: "读取媒体附件失败", referenceImage: "参考图", generatedImageReadFailed: "读取 Codex 生成图片失败", generatedImageName: "生成图片 {{index}}",
        },
    },
    locale: {
        zhCN: "简体中文",
